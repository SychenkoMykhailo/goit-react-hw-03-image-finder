Task 02. Поиск изображений (похожа на одну из последних домашек по JS)
...
Your API key: 21267316-e2b69c8f3d224355a08642050

https://pixabay.com/api/?q=что*искать&page=номер*страницы&key=твой*ключ&image_type=photo&orientation=horizontal&per_page=12
